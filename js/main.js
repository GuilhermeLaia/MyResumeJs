...
(function($){
	...
	// substituir os parametros na string por valores
	...
	MY_RESUME.launchTimeline = function(dataUrl, lang){
		...
		// Definir o size para o responsive
		if(windowWidth <= 480){
	...
	$(document).ready(function() {
		...
		$('#ascensorBuilding').ascensor({
			...
			childType: 'section',
			ascensorFloorName: 'Profile | Skills | Carrers | Hobies | Contatos',
			time: 1000,
			windowsOn: 0,
			direction: "chocolate",
